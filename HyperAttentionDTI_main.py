...
#os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3,4,5" # 单机单进程多卡训练
...
if __name__ == "__main__":
    ...
    # random shuffle
    print("data shuffle")
    dataset = shuffle_dataset(train_data_list, SEED) # Shuffle 对数据集随机排列
    K_Fold = 5
    ...
    for i_fold in range(K_Fold):
        ...
        '''
        #2,单机多进程多卡gpu        python -m torch.distributed.launch HyperAttentionDTI_main.py
        ...
        '''
        #3,单机多进程多卡gpu        python -m torch.distributed.launch HyperAttentionDTI_main.py
